...
$favouritesProducts = [];
if ($id_user) {
    $favouritesProducts = $db->getFavouriteProducts($id_user);
}
        ...
        <div class="main__wrap">
            <section class="products">
                ...
                <? if (!$favouritesProducts) : ?>
                    <h3 class="title_small">Добавленные в избранное продукты отобразятся здесь</h3>
                <? endif; ?>
                <div class="products__list">
                    <? foreach ($favouritesProducts as $product) : ?>
