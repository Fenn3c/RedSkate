...
<body>
    ...
    <main class="main main_main-page">
        <div class="main__wrap main__wrap_horizontal">
            <aside class="filter">
                <form method="get" class="filter__form autosubmit">
            ...
            <div class="">
                ...
                <div class="pagination">
                    <form class="pagination__form" action="">
                        ...
                        <?
                        $oldParams = preg_replace('/&?page=\d+/', '', http_build_query($_GET));

                        $previousPage = $page - 1 >= 1 ? $page - 1 : 1;
                        $url = "./shop.php?$oldParams&page=$previousPage";

                        ?>
                        <a href="<?= $url ?>" class="pagination__button"><svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        ?>
                            <?
                            $url = "./shop.php?$oldParams&page=$i";
                            ?>
                            <a class="pagination__button <?= $page == $i ? 'pagination__button_active' : '' ?>" href="<?= $url ?>" ?><?= $i ?></a>
                        <? endfor; ?>
                        <?
                        $nextPage = $page + 1 <= $countPages ? $page + 1 : $countPages;
                        $url = "./shop.php?$oldParams&page=$nextPage";
                        ?>
