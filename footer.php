    ...
    <div class="footer__wrap">
        <div class="footer__top">
            <a href="" class="footer__logo-link">
                <img src="./assets/img/svg/logo-white.svg" alt="" class="footer__logo">
            </a>
            <div class="footer__contacts">
                <p class="footer__contacts-title">Связаться с нами</p>
                <a href="tel:+79442133412" class="footer__contact">+7 (944) 213-34-12</a>
                <a href="mailto:shop@redskate.ru" class="footer__contact">shop@redskate.ru</a>
                <span class="footer__contact_no-click">Хрущевский пер., 47, Москва, 138042</span>
            </div>
        </div>
        <div class="footer__bottom">
            ...
            <div class="footer__partners">
                <img src="./assets/img/png/partners.png" alt="" class="footer__partners-img">
            </div>
        </div>
        <p class="footer__copyright">© RedSkate | Официальный сайт компании. Все права защищены.</p>
    </div>
</footer>